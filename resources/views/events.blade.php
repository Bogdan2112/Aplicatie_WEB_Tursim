...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/aos-by-red.css') }}">
...
<body>
    ...
    <section class="card-gallery-section">
        <div class="card-gallery">
            ...
            <div class="full-card">
                <a href="{{ route('cards.show', $card) }}" style="display: block; text-decoration: none; color: inherit;">
                    <div class="card">
                        <div class="poster">
                    ...
                    <div class="name">
                        <p>{{ $card->city }}</p>
                        <span class="ctn">Learn More</span>
                    </div>
                </a>
            </div>
            @endforeach
    ...
    <section class="sub-header sub2">
        <div class="header-content sub-content">
            <h1>Upcoming events</h1>
            <div class="line"></div>
            <div class="time-content">
                <div class="time days">
                    <span class="number dadada"></span>
